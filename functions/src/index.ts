...
const configureFunctions = functions.config();
const configureFirebase = configureFunctions.firebase;
const activeEnviroment = configureFunctions.env.active;
const frefixDatabase = configureFunctions.prefixdatabase[activeEnviroment];

admin.initializeApp(configureFirebase);
...
const contactsCollection = `${frefixDatabase}users`;
